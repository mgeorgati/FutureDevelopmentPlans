...
if city == 'grootams':
    from grootams_config import country, ancillary_data_folder_path, temp_shp_path,  temp_tif_path, raster_file, conn,cur, engine 
    nuts3_cd1 = ''
elif city == 'ams':
    from ams_config import country, ancillary_data_folder_path, temp_shp_path, temp_tif_path, raster_file, conn,cur, engine
elif city == 'cph':
    from cph_config import country, ancillary_data_folder_path, temp_shp_path,  temp_tif_path, raster_file, conn,cur, engine
elif city == 'crc':
    from crc_config import country, ancillary_data_folder_path, temp_shp_path, temp_tif_path, raster_file, conn,cur, engine 
elif city == 'rom':
    from rom_config import country, ancillary_data_folder_path, temp_shp_path,  temp_tif_path, raster_file, conn,cur, engine 
