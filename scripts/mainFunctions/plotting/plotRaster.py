...
sys.path.append('C:/Users/NM12LQ/OneDrive - Aalborg Universitet/SpatialDisaggregation/SDis_Self-Training/plotting/') 
#from plotting.binsDefinition import defineBinsRaster
from binsDefinition import defineBins

def plot_map(city, evalType, src, exportPath, title, LegendTitle, attr_value, districtPath, neighPath, streetsPath, waterPath, invertArea, addLabels=True):
    ...
    if invertArea:
        ...
        outArea.plot(ax=ax, facecolor='#FFFFFF', edgecolor='#000000', linewidth=.3, zorder=15 )
    if neighPath:
