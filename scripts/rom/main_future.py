...
from config.rom_config import city, raster_file, cur, conn, engine, temp_shp_path, futureDataFolder
...
if init_trainProcess == "yes": 
    src_file = data_path + "/shp/{0}_metrostations.geojson".format(city)   
    year_list = [2025, 2030, 2035, 2040, 2045, 2050]#,2025, 2030, 2035, 2040, 2045, 2050]
    transport_means = '{}_metrostations'.format(scenario) 
