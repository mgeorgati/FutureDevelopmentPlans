    ...
    <rasterrenderer classificationMin="1" band="1" type="singlebandpseudocolor" alphaBand="-1" classificationMax="inf" opacity="1">
      ...
      <rastershader>
        <colorrampshader classificationMode="2" clip="0" colorRampType="DISCRETE">
          ...
          <item value="1" color="#f1eef6" label="&lt;= 1" alpha="0"/>
          <item value="2000" color="#e8d9ec" label="1 - 2000" alpha="253"/>
          <item value="5000" color="#d587df" label="2000 - 5000" alpha="255"/>
          <item value="10000" color="#e526c8" label="5000 - 10000" alpha="255"/>
          <item value="20000" color="#a01479" label="10000 - 20000" alpha="255"/>
          <item value="inf" color="#97154e" label="> 20000" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
